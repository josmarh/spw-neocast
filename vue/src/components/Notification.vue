...
<div>
    <div v-if="successMsg">
        <div id="toast-success" class="absolute flex items-center w-full max-w-sm p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800 divide-x divide-gray-200 right-5 top-20" role="alert">
            ...
            <div class="ml-3 text-sm font-normal">{{successMsg}}</div>
                <button type="button" @click="resetNotification('success')"
        ...
        <div v-else-if="errorMsg">
            <div id="toast-error" class="absolute flex items-center w-full max-w-sm p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800 divide-x divide-gray-200 right-5 top-20" role="alert">
            ...
            <button type="button" @click="resetNotification('error')"
                class="ml-auto -mx-1.5 -my-1.5 bg-white text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex h-8 w-8 dark:text-gray-500 dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700" 
