...
import 'videojs-linear-tv-prototype';


export default {
  name: 'VideoPlayerLinear',
  props: {
    options: {
      type: Object,
      default() {
  ...
  mounted() {
    ...
    // customly display live 
    let live = document.getElementsByClassName('vjs-live-control')[0];
    live.style.display = 'block';
    setTimeout(() => {
        live.classList.remove('vjs-hidden');
    }, 1500)
