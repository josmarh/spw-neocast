    ...
    await store
        ...
        .then((res) => {
            if(res.data.length) {
                ...
                streamLink.value = `https://tubetargeterapp.com:3070/channels/${chash.stream_name}.m3u8`
                if(chash.channel_type.includes('Linear')) {
                    videoOptionsLinear.sources[0].src = `https://tubetargeterapp.com:3070/channels/${chash.stream_name}.m3u8`;
