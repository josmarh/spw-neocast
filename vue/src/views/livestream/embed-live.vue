<template>
    <div>
        ...
        <div v-if="streamStatus == 3" class="flex justify-center items-center">
            <div class="p-20 w-full bg-black border shadow-md xl:p-64 xl:h-screen sm:h-screen dark:bg-gray-800 dark:border-gray-700 text-center">
