<template>
                    ...
                    >
                        ...
                        <div class="flex mb-2 justify-center">
                            ...
                            <div class="rounded-full transition-color cursor-pointer 
                                bg-[rgb(88,80,236)] hover:bg-gray-900 px-2 py-1 mr-3 tooltip">
                                <span class="text-white" @click="editVideo(cont)">
                            ...
                            <div class="rounded-full transition-color cursor-pointer 
                                bg-[rgb(88,80,236)] hover:bg-gray-900 px-2 py-1 mr-3 tooltip">
                                <span class="text-white" @click="embedContent(cont)">
                            ...
                            <!-- Download video btn -->
                            <div class="rounded-full transition-color cursor-pointer 
                                bg-[rgb(88,80,236)] hover:bg-gray-900 px-2 py-1 mr-3 tooltip-download">
                                <span class="text-white" @click.prevent="downloadContent(cont)">
                            ...
                            <div class="rounded-full transition-color cursor-pointer 
                                bg-[rgb(88,80,236)] hover:bg-gray-900 px-2 py-1 mr-3 tooltip">
                                <span class="text-white" @click.prevent="confirmDelete(cont)">
    ...
    <ScheduleSetup 
    :scheduleSetupState="showScheduleSetup"
    @updateScheduleState="hideScheduleSetup" />
</template>
...
import ScheduleSetup from "../../components/video/ScheduleSetup.vue";
...
let showScheduleSetup = ref(false)
...
watch(searchParam, (after, before) => {
    setTimeout(() => searchContent(after), 2000)
},{deep: true})
...
const setContentItems = data => {
    model.value = data
    showScheduleSetup.value = true
}

const hideScheduleSetup = () => {
